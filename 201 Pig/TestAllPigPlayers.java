...
public class TestAllPigPlayers extends TestCase {
  ...
  private static long simulations = 10000;  // small numbers will run faster, but may occassionally give the wrong result
  ...
  public void testSimpleHoldGeneral() {
    ...
    assertTrue(player.isRolling(10, 99));
  }
  ...
  public void testFourTurnsComparison() {
    FourTurnsPlayer four = new FourTurnsPlayer("four turns");
